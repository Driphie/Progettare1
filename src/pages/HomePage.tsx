...
const HomePage = () => {
  const winterProducts = getProductsBySeason('invierno').slice(0, 4);
  const summerProducts = getProductsBySeason('verano').slice(0, 4);
  const ambosProducts = getProductsByType('ambo').slice(0, 4);
    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 bg-tailor-cream">
        <div className="container mx-auto px-4">
          ...
          <ProductGrid products={ambosProducts} />
          <div className="mt-8 text-center">
