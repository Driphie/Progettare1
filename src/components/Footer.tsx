      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            ...
            <p className="text-sm text-gray-300">Sartoria Uomo</p>
          </div>
          
          <div className="flex flex-col space-y-2 mb-6 md:mb-0 items-center md:items-start">
            <div className="flex items-center gap-2">
              <Phone size={16} />
              <span className="text-sm">+54 11 6710-5625</span>
            </div>
            <div className="flex items-center gap-2">
              <Mail size={16} />
              <span className="text-sm">Progettarepc@gmail.com</span>
            </div>
            <div className="flex items-center gap-2">
              <MapPin size={16} />
          ...
          <div className="flex flex-col space-y-2 items-center md:items-end">
            ...
            <Link to="/camisas" className="text-sm hover:text-gray-300 transition-colors">Camisas</Link>
